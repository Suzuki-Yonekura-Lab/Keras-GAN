...
# 生成器のアーキテクチャ図を生成
plot_model(generator, to_file='WGAN-gp/output/architecture/generator_model_v1.png', show_shapes=True, show_layer_names=True)

# 識別器のアーキテクチャ図を生成
plot_model(discriminator, to_file='WGAN-gp/output/architecture/discriminator_model_v1.png', show_shapes=True, show_layer_names=True)
