...
class GANMonitor(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        for i in range(self.num_img):
            ...
            img.save("WGAN-gp/output/mnist/generated_img_%03d_%d.png" % (epoch, i))
...
if __name__ == "__main__":
    ...
    output_dir = "WGAN-gp/output/mnist/"
    ...
    gan.fit(
        ...
        callbacks=[
            ...
            LossCSVLogger(filename="WGAN-gp/output/mnist/loss_log.csv")
        ],
    )
