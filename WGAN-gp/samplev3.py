...
# 生成器のアーキテクチャ図を生成
plot_model(generator, to_file='generator_model_v3.png', show_shapes=True, show_layer_names=True)

# 識別器のアーキテクチャ図を生成
plot_model(discriminator, to_file='discriminator_model_v3.png', show_shapes=True, show_layer_names=True)
