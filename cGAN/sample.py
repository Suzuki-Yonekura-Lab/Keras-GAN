...
# 生成器のアーキテクチャ図を生成
plot_model(generator, to_file='cGAN/output/architecture/generator_model_v1.png', show_shapes=True, show_layer_names=True)

# 識別器のアーキテクチャ図を生成
plot_model(discriminator, to_file='cGAN/output/architecture/discriminator_model_v1.png', show_shapes=True, show_layer_names=True)
...
class GANMonitor(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        for i in range(self.num_img):
            ...
            img.save("cGAN/output/samplev1/generated_img_%03d_%d.png" % (epoch, i))
